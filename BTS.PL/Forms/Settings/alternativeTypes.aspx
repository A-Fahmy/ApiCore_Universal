<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="alternativeTypes.aspx.cs" Inherits="BTS.PL.Forms.Settings.alternativeTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
      <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New alternative Type" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
          <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:BoundField DataField="Code" HeaderText="File Type Code" />
                    <asp:BoundField DataField="alternativeNameEn" HeaderText="English Name" />
                    <asp:BoundField DataField="alternativeNameAr" HeaderText="Arabic Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add alternative Type
                            </h4>
                        </div>
 ...
 <%--                           <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtalternativeTypeCode" CssClass="form-control" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtalternativeTypeCode" ErrorMessage="*" ForeColor="Red"
