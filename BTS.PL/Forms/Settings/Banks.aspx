<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Banks.aspx.cs" Inherits="BTS.PL.Forms.Settings.Banks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
        <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New Bank" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
            <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BankNameEn" HeaderText="English Name" />
                    <asp:BoundField DataField="BankNameAR" HeaderText="Arabic Name" />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-8">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBanKCode" ErrorMessage="*" ForeColor="Red"
                            ...
                            <div class="col-md-8">
                                ...
                                <asp:RequiredFieldValidator ID="rfvBankCountry" runat="server" ControlToValidate="ddlCountries" ErrorMessage="*" ForeColor="Red"
                                    ValidationGroup="EditForm"></asp:RequiredFieldValidator>
                            </div>
                            <br />
                              <div class="col-md-4">
