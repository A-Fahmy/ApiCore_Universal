<%@ Page Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="BankBranch.aspx.cs" Inherits="BTS.PL.Forms.Settings.BankBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
        <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New Bank Branch" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
            <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BankBranchNameAR" HeaderText="English Name" />
                    <asp:BoundField DataField="BankBranchNameEN" HeaderText="Arabic Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtBranchCode" CssClass="form-control" runat="server" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBranchCode" ErrorMessage="*" ForeColor="Red"
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlBanks" runat="server" class="dropmenu" DataTextField="BankNameEN" DataValueField="Code">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvBankCountry" runat="server" ControlToValidate="ddlBanks" ErrorMessage="*" ForeColor="Red"
                                    ValidationGroup="EditForm"></asp:RequiredFieldValidator>
                            </div>
                            <br />
                              <div class="col-md-4">
