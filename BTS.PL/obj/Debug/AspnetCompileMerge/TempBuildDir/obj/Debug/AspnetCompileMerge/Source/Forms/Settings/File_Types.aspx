<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="File_Types.aspx.cs" Inherits="BTS.PL.Forms.Settings.File_Types" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New File Type" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
          <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="FileTypeNameEN" HeaderText="English Name" />
                    <asp:BoundField DataField="FileTypeNameAR" HeaderText="Arabic Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add File Type
                            </h4>
                        </div>
