<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Cities.aspx.cs" Inherits="BTS.PL.Forms.Settings.Cities" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
            ...
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New City" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
            <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:BoundField DataField="CityNameEn" HeaderText="English Name" />
                    <asp:BoundField DataField="CityNameAR" HeaderText="Arabic Name" />
                    <asp:BoundField DataField="ProvinceName" HeaderText="Province Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add City
                            </h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlCountries" runat="server" class="dropmenu"  DataTextField="Name" DataValueField="Code" OnSelectedIndexChanged="ddlCountries_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rvfCrovince" runat="server" ControlToValidate="ddlCountries" ErrorMessage="*" ForeColor="Red"
                                    ValidationGroup="EditForm"></asp:RequiredFieldValidator>
                            </div>
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlProvinces" runat="server" class="dropmenu"  DataTextField="Name" DataValueField="Code">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rvfProvince" runat="server" ControlToValidate="ddlProvinces" ErrorMessage="*" ForeColor="Red"
                                    ValidationGroup="EditForm"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-4">
                                Is Active
