...
<%--                    <asp:BoundField DataField="GroupID" HeaderText="Group" />--%>
                  <asp:BoundField DataField="PageName" HeaderText="Page Name"  ItemStyle-CssClass ="hiddencol" HeaderStyle-CssClass="hiddencol" />
                                      <asp:BoundField DataField="URLPageName" HeaderText="Page Name" />
                    ...
                    <asp:TemplateField HeaderText="Select All">
                        <ItemTemplate>
                         <%--   <asp:ImageButton ID="btnEdit" runat="server" CausesValidation="false"
                            ...
                            <asp:Button ID="btnEdit" runat="server" Text="Un\Select All" CausesValidation="false" SelectedID='<%# Eval("Code") %>' class="btn btn-primary" OnClick="btnEdit_Click" AutoPostBack="false" />
