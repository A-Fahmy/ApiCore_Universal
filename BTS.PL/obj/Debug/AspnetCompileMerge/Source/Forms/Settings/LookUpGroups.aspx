<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="LookUpGroups.aspx.cs" Inherits="BTS.PL.Forms.Settings.LookUpGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
     <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New Group" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
          <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="GroupsNameEN" HeaderText="English Name" />
                    <asp:BoundField DataField="GroupsNameAR" HeaderText="Arabic Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add  Group
                            </h4>
                        </div>
