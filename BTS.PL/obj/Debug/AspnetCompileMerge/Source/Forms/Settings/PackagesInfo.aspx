<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="PackagesInfo.aspx.cs" Inherits="BTS.PL.Forms.Settings.PackagesInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
 <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New Info"  class="btn btn-primary"  OnClick="btnAddNewItem_Click" />
            <br />
            <br />
          <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Link1" HeaderText="First Link" />
                    <asp:BoundField DataField="Link2" HeaderText="Second Link" />
                    <asp:BoundField DataField="PackageType" HeaderText="Package Type" />
                    <asp:BoundField DataField="DescriptionAR" HeaderText="Arabic Description" />
                    <asp:BoundField DataField="DescriptionEN" HeaderText="English Descriptoin" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Add  Package Info
                            </h4>
                        </div>
...
<%--                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtName" TextMode="MultiLine" Rows="5" CssClass="form-control" runat="server" />
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtNameAr" TextMode="MultiLine" Rows="5" CssClass="form-control" runat="server" />
                        ...
                        <br />
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtLink1"  CssClass="form-control" runat="server" />
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="txtLink2"  CssClass="form-control" runat="server" />
                            ...
                            <div class="col-md-8">                          
                                <asp:DropDownList ID="ddlPackageType" AutoPostBack="false" Width="100%"  runat="server" >
                    <asp:ListItem Text="DCH" Value="1"></asp:ListItem>
                     <asp:ListItem Text="GPP" Value="2"></asp:ListItem>
                       <asp:ListItem Text="FXP" Value="3"></asp:ListItem>
                       </asp:DropDownList>
                                </div>
