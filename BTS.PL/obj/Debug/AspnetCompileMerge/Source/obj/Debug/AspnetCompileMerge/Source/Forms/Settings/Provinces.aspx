<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="Provinces.aspx.cs" Inherits="BTS.PL.Forms.Settings.Provinces" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
        ...
        <ContentTemplate>
            <asp:Button ID="btnAddNewItem" runat="server" Text="Add New Province" class="btn btn-primary" OnClick="btnAddNewItem_Click" />
            <br />
            <br />
            <asp:GridView ID="gvData" runat="server" CssClass="table table-responsive" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:BoundField DataField="ProvinceNameEn" HeaderText="Province English Name" />
                    <asp:BoundField DataField="ProvinceNameAR" HeaderText="Province Arabic Name" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel"> Add Province
                            </h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList ID="ddlCountries" runat="server" class="dropmenu" DataTextField="Name" DataValueField="Code"/>
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlCountries" ErrorMessage="*" ForeColor="Red"
                                    ValidationGroup="EditForm"></asp:RequiredFieldValidator>
                            </div>
     ...
     <div  class="modal fade" id="itemModalPopUp" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
        ...
        <asp:Button ID="No" runat="server" Text="No"  OnClick="No_Click"  CausesValidation="true" class="btn btn-default" data-dismiss="modal" />
    </div>
               </div>
            </div>
        </div>
