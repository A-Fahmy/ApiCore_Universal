...
<body>
    <form id="form1" runat="server">
        <div class="container" runat="server" id="Verify">
            ...
            <div class="row">
                <h3 class="form-signin-heading">Please Enter UserID and Password</h3>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    ...
                    <asp:Button ID="btnVerify" type="submit" Font-Bold="true" Width="40%" class="form-control" Text="Verify" runat="server" OnClick="btnVerify_Click"></asp:Button>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
 ...
 ValidationExpression="(.+\.([Bb][Mm][Pp])|.+\.([Dd][Oo][Cc])|.+\.([Tt][Xx][Tt])|.+\.([Pp][Dd][Ff])|.+\.([Dd][Oo][Cc][Xx])|.+\.([Xx][Ll][Ss][Xx])|.+\.([Jj][Pp][Gg]))"></asp:RegularExpressionValidator>
                ...
                <div class="col-lg-2">
                    <asp:Button ID="btnBuyCheckYN" Enabled="false" Visible="false" Width="100%" runat="server" class="btn btn-primary" Text="Pay Now" OnClick="btnBuyCheckYN_Click" />
                </div>
            </div>
             <div class="row">
                 <div class="col-lg-4">
                  ...
                  <div class="col-lg-3">
                       <asp:Button ID="btn_ONLineForm" Enabled="false" Width="100%" runat="server" class="btn btn-primary" Text="ON Line Form"  />
                  </div>
                   <div class="col-lg-3">
                        <asp:Button ID="btn_SpecialExpForm" Enabled="false" Width="100%" runat="server" class="btn btn-primary" Text="Special Expertise Form"  />
                  </div>
        ...
        <div class="row">
           ...
           <div class="row">
            <div class="col-lg-12">
                ...
                <asp:Button ID="btnAddComment" Width="15%"   runat="server" class="btn btn-primary" Text="Add Comment" OnClick="btnAddComment_Click" />
                    ...
                    <asp:GridView ID="GridLog" runat="server" CssClass="table table-condensed table-hover" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LogDate" DataFormatString = "{0:dd/MM/yyyy hh:mm}" ItemStyle-Width="12%" HeaderText="Date" />
